...
- Active 작업지시서: `docs/exec-plans/mvp/active/12-banner-ad.md`
- 직전 완료 문서: `docs/exec-plans/mvp/completed/11-firebase-release-secret-manager-setup-result.md`
...
- [x] 작업 시작 시 `docs/exec-plans/mvp/completed/11-firebase-release-secret-manager-setup-result.md`를 읽고 운영 환경값 관련 남은 항목을 반영했다.
